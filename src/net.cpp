...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "GammaCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"gammacointools.com", "dnsseed.gammacointools.com"},
    {"gammacoinpool.org", "dnsseed.gammacoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"gammacointools.com", "testnet-seed.gammacointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. GammaCoin is probably already running."), addrBind.ToString().c_str());
        else
